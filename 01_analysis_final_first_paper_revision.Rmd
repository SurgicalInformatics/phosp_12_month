...
save.image(paste("full_image_", timestamp, ".Rdata"), compress = TRUE)
```

```{r}
timestamp = "2021-09-08_1203"
load(paste("full_image_", timestamp, ".Rdata"))
```
...
saveRDS(phosp_hosp_imputed, file = paste0("phosp_hosp_imputed_", timestamp, ".rds"))
```

```{r}
# Load mice sets
phosp_hosp_imputed = readRDS(paste0("phosp_hosp_imputed_", timestamp, ".rds"))
```
...
saveRDS(phosp_hosp_imputed, file = paste0("phosp_hosp_imputed_", timestamp, "_2.rds"))
```

```{r}
# Load mice sets
phosp_hosp_imputed = readRDS(paste0("phosp_hosp_imputed_", timestamp, "_2.rds"))
```
