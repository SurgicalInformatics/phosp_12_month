...
# Use the phosp_clean dataset in data store
...
353 complete cases. An extra 81 if complete moca not required etc. 

I think I misled earlier, all patients in clustering analysis have complete data (1503) and 353 have paired data between 3 and 12 months. To utilise more pairs, either a variable such as moca would have to be dropped from the cluster, or missing moca imputed. 
...
saveRDS(m1_beta, file = paste0("m1_beta_imputed1", timestamp, ".rds"))
...
saveRDS(m2_beta, file = paste0("m2_beta_imputed1", timestamp, ".rds"))
...
m1_beta = readRDS(paste0("m1_beta_imputed1", timestamp, ".rds"))
m2_beta = readRDS(paste0("m2_beta_imputed1", timestamp, ".rds"))
m_beta = c(m1_beta, m2_beta)
```
